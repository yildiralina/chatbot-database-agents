...
df = pd.read_csv("./data/credit-card-default.csv").fillna(value=0)
...
QUESTION = "Which education category has the highest default rate?"

# Streamlit application for displaying results.
st.title("Chatbot Database Agents: Interacting with CSV Data")
...
question = st.text_input(
    ...
    "Which education category has the highest default rate?",
)
